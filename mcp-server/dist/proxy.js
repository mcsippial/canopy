...
export async function startProxy(config) {
    ...
    const server = new Server({ name: 'canopy-monitor', version: '0.1.0' }, { capabilities: { tools: {} } });
    let callDepth = 0;
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        // Check compliance
        const compliance = checkCompliance(request.params.name, callDepth, todayActionCount, config);
        // Build action log
        const actionLog = {
